...
var HTMLWidget = function () {
  function HTMLWidget(value) {
    _classCallCheck(this, HTMLWidget);

    this.value = value;
  }

  HTMLWidget.prototype.update = function update(prev, node) {
    if (prev.value !== this.value) {
      return this.init();
    }
  };

  HTMLWidget.prototype.init = function init() {
...
var VDomRuntime = function (_PugRuntime) {
  ...
  VDomRuntime.prototype.text = function text(_text, unescape) {
    if (_text && unescape) {
      return new HTMLWidget(_text);
    }
